(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId]){return installedModules[moduleId].exports}
    ...
    __webpack_require__.m=modules;__webpack_require__.c=installedModules;__webpack_require__.i=function(value){return value};__webpack_require__.d=function(exports,name,getter){if(!__webpack_require__.o(exports,name)){Object.defineProperty(exports,name,{configurable:!1,enumerable:!0,get:getter})}};__webpack_require__.n=function(module){var getter=module&&module.__esModule?function getDefault(){return module['default']}:function getModuleExports(){return module};__webpack_require__.d(getter,'a',getter);return getter};__webpack_require__.o=function(object,property){return Object.prototype.hasOwnProperty.call(object,property)};__webpack_require__.p="/build/";return __webpack_require__(__webpack_require__.s=33)})([(function(module,exports,__webpack_require__){"use strict";var bind=__webpack_require__(8);var isBuffer=__webpack_require__(38);var toString=Object.prototype.toString;function isArray(val){return toString.call(val)==='[object Array]'}
    ...
    module.exports={isArray:isArray,isArrayBuffer:isArrayBuffer,isBuffer:isBuffer,isFormData:isFormData,isArrayBufferView:isArrayBufferView,isString:isString,isNumber:isNumber,isObject:isObject,isUndefined:isUndefined,isDate:isDate,isFile:isFile,isBlob:isBlob,isFunction:isFunction,isStream:isStream,isURLSearchParams:isURLSearchParams,isStandardBrowserEnv:isStandardBrowserEnv,forEach:forEach,merge:merge,extend:extend,trim:trim}}),(function(module,exports,__webpack_require__){module.exports=__webpack_require__(16)}),(function(module,exports,__webpack_require__){"use strict";(function(process){var utils=__webpack_require__(0);var normalizeHeaderName=__webpack_require__(30);var DEFAULT_CONTENT_TYPE={'Content-Type':'application/x-www-form-urlencoded'};function setContentTypeIfUnset(headers,value){if(!utils.isUndefined(headers)&&utils.isUndefined(headers['Content-Type'])){headers['Content-Type']=value}}
    function getDefaultAdapter(){var adapter;if(typeof XMLHttpRequest!=='undefined'){adapter=__webpack_require__(4)}else if(typeof process!=='undefined'){adapter=__webpack_require__(4)}
        return adapter}
    var defaults={adapter:getDefaultAdapter(),transformRequest:[function transformRequest(data,headers){normalizeHeaderName(headers,'Content-Type');if(utils.isFormData(data)||utils.isArrayBuffer(data)||utils.isBuffer(data)||utils.isStream(data)||utils.isFile(data)||utils.isBlob(data)){return data}
            ...
            return data}],timeout:0,xsrfCookieName:'XSRF-TOKEN',xsrfHeaderName:'X-XSRF-TOKEN',maxContentLength:-1,validateStatus:function validateStatus(status){return status>=200&&status<300}};defaults.headers={common:{'Accept':'application/json, text/plain, */*'}};utils.forEach(['delete','get','head'],function forEachMethodNoData(method){defaults.headers[method]={}});utils.forEach(['post','put','patch'],function forEachMethodWithData(method){defaults.headers[method]=utils.merge(DEFAULT_CONTENT_TYPE)});module.exports=defaults}.call(exports,__webpack_require__(10)))}),(function(module,exports){var g;g=(function(){return this})();try{g=g||Function("return this")()||(1,eval)("this")}catch(e){if(typeof window==="object")
    g=window}
    module.exports=g}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);var settle=__webpack_require__(22);var buildURL=__webpack_require__(25);var parseHeaders=__webpack_require__(31);var isURLSameOrigin=__webpack_require__(29);var createError=__webpack_require__(7);var btoa=(typeof window!=='undefined'&&window.btoa&&window.btoa.bind(window))||__webpack_require__(24);module.exports=function xhrAdapter(config){return new Promise(function dispatchXhrRequest(resolve,reject){var requestData=config.data;var requestHeaders=config.headers;if(utils.isFormData(requestData)){delete requestHeaders['Content-Type']}
    ...
    request.send(requestData)})}}),(function(module,exports,__webpack_require__){"use strict";function Cancel(message){this.message=message}
    Cancel.prototype.toString=function toString(){return'Cancel'+(this.message?': '+this.message:'')};Cancel.prototype.__CANCEL__=!0;module.exports=Cancel}),(function(module,exports,__webpack_require__){"use strict";module.exports=function isCancel(value){return!!(value&&value.__CANCEL__)}}),(function(module,exports,__webpack_require__){"use strict";var enhanceError=__webpack_require__(21);module.exports=function createError(message,config,code,request,response){var error=new Error(message);return enhanceError(error,config,code,request,response)}}),(function(module,exports,__webpack_require__){"use strict";module.exports=function bind(fn,thisArg){return function wrap(){var args=new Array(arguments.length);for(var i=0;i<args.length;i++){args[i]=arguments[i]}
    return fn.apply(thisArg,args)}}}),(function(module,exports){module.exports=function(){var list=[];list.toString=function toString(){var result=[];for(var i=0;i<this.length;i++){var item=this[i];if(item[2]){result.push("@media "+item[2]+"{"+item[1]+"}")}else{result.push(item[1])}}
    ...
    for(i=0;i<modules.length;i++){var item=modules[i];if(typeof item[0]!=="number"||!alreadyImportedModules[item[0]]){if(mediaQuery&&!item[2]){item[2]=mediaQuery}else if(mediaQuery){item[2]="("+item[2]+") and ("+mediaQuery+")"}
        list.push(item)}}};return list}}),(function(module,exports){var process=module.exports={};var cachedSetTimeout;var cachedClearTimeout;function defaultSetTimout(){throw new Error('setTimeout has not been defined')}
    ...
    process.binding=function(name){throw new Error('process.binding is not supported')};process.cwd=function(){return'/'};process.chdir=function(dir){throw new Error('process.chdir is not supported')};process.umask=function(){return 0}}),(function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(9)();exports.push([module.i,"button,\ninput,\nselect,\ntextarea {\n    outline: none;\n    border: 0;\n}\n\nbody{\n    padding: 0;\n    margin: 0;\n    width: 100%;\n    background-color: #E6E6E6;\n}\n\nheader {\n    text-align: center;\n    font-size: 22px;\n    font-weight: 600;\n    padding-top: 15px;\n    margin: 0;\n    width: 100%;\n    height: 60px;\n    background-color: #4A76A8;\n    border-bottom: 1px solid #C1C1C1;\n    color: white;\n}\n\n.block {\n    margin-top: 15px;\n    padding: 15px;\n    background-color: white;\n    width: 100%;\n}\n\n.hint {\n    margin: 5px 0 0 0;\n    font-size: 13px;\n    letter-spacing: 1px;\n}\n\nbutton {\n    margin-top: 5px;\n    width: 200px;\n    height: 35px;\n    color: white;\n    background-color: #4A76A8;\n    margin-bottom: 15px;\n    padding: 0 30px 0 30px;\n    -o-transition: .5s;\n    -moz-transition: .5s;\n    -ms-transition: .5s;\n    -webkit-transition: .5s;\n    transition: .5s;\n}\n\nbutton:hover {\n    background-color: #114575;\n}\n\ninput[type=\"text\"], input[type=\"number\"], select {\n    margin-top: 5px;\n    color: #4E4E50;\n    padding: 10px 10px 10px 10px;\n    font-size: 15px;\n    height: 35px;\n    border: 1px solid #3A8BCE;\n    -o-box-shadow: inset 2px 2px 5px rgba(154, 147, 140, 0.4), 1px 1px 5px rgba(255, 255, 255, 1);\n    -moz-box-shadow: inset 2px 2px 5px rgba(154, 147, 140, 0.4), 1px 1px 5px rgba(255, 255, 255, 1);\n    -ms-box-shadow: inset 2px 2px 5px rgba(154, 147, 140, 0.4), 1px 1px 5px rgba(255, 255, 255, 1);\n    -webkit-box-shadow: inset 2px 2px 5px rgba(154, 147, 140, 0.4), 1px 1px 5px rgba(255, 255, 255, 1);\n    box-shadow: inset 2px 2px 5px rgba(154, 147, 140, 0.4), 1px 1px 5px rgba(255, 255, 255, 1);\n}\n\n.half-width {\n    width: calc(100% - 205px);\n}\n\n.full-width {\n    width: 100%;\n}",""])}),(function(module,exports,__webpack_require__){var __vue_exports__,__vue_options__
    var __vue_styles__={}
    __vue_exports__=__webpack_require__(34)
    var __vue_template__=__webpack_require__(43)
    __vue_options__=__vue_exports__=__vue_exports__||{}
    if(typeof __vue_exports__.default==="object"||typeof __vue_exports__.default==="function"){__vue_options__=__vue_exports__=__vue_exports__.default}
    if(typeof __vue_options__==="function"){__vue_options__=__vue_options__.options}
    __vue_options__.render=__vue_template__.render
    __vue_options__.staticRenderFns=__vue_template__.staticRenderFns
    module.exports=__vue_exports__}),(function(module,exports,__webpack_require__){var __vue_exports__,__vue_options__
    var __vue_styles__={}
    ...
    __vue_options__.render=__vue_template__.render
    __vue_options__.staticRenderFns=__vue_template__.staticRenderFns
    module.exports=__vue_exports__}),(function(module,exports,__webpack_require__){(function(global,setImmediate){(function(global,factory){!0?module.exports=factory():typeof define==='function'&&define.amd?define(factory):(global.Vue=factory())}(this,(function(){'use strict';var emptyObject=Object.freeze({});function isUndef(v){return v===undefined||v===null}
    ...
    Vue.compile=compileToFunctions;return Vue})))}.call(exports,__webpack_require__(3),__webpack_require__(40).setImmediate))}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);var bind=__webpack_require__(8);var Axios=__webpack_require__(18);var defaults=__webpack_require__(2);function createInstance(defaultConfig){var context=new Axios(defaultConfig);var instance=bind(Axios.prototype.request,context);utils.extend(instance,Axios.prototype,context);utils.extend(instance,context);return instance}
    var axios=createInstance(defaults);axios.Axios=Axios;axios.create=function create(instanceConfig){return createInstance(utils.merge(defaults,instanceConfig))};axios.Cancel=__webpack_require__(5);axios.CancelToken=__webpack_require__(17);axios.isCancel=__webpack_require__(6);axios.all=function all(promises){return Promise.all(promises)};axios.spread=__webpack_require__(32);module.exports=axios;module.exports.default=axios}),(function(module,exports,__webpack_require__){"use strict";var Cancel=__webpack_require__(5);function CancelToken(executor){if(typeof executor!=='function'){throw new TypeError('executor must be a function.')}
    var resolvePromise;this.promise=new Promise(function promiseExecutor(resolve){resolvePromise=resolve});var token=this;executor(function cancel(message){if(token.reason){return}
        token.reason=new Cancel(message);resolvePromise(token.reason)})}
    CancelToken.prototype.throwIfRequested=function throwIfRequested(){if(this.reason){throw this.reason}};CancelToken.source=function source(){var cancel;var token=new CancelToken(function executor(c){cancel=c});return{token:token,cancel:cancel}};module.exports=CancelToken}),(function(module,exports,__webpack_require__){"use strict";var defaults=__webpack_require__(2);var utils=__webpack_require__(0);var InterceptorManager=__webpack_require__(19);var dispatchRequest=__webpack_require__(20);function Axios(instanceConfig){this.defaults=instanceConfig;this.interceptors={request:new InterceptorManager(),response:new InterceptorManager()}}
    ...
    module.exports=function dispatchRequest(config){throwIfCancellationRequested(config);if(config.baseURL&&!isAbsoluteURL(config.url)){config.url=combineURLs(config.baseURL,config.url)}
        config.headers=config.headers||{};config.data=transformData(config.data,config.headers,config.transformRequest);config.headers=utils.merge(config.headers.common||{},config.headers[config.method]||{},config.headers||{});utils.forEach(['delete','get','head','post','put','patch','common'],function cleanHeaderConfig(method){delete config.headers[method]});var adapter=config.adapter||defaults.adapter;return adapter(config).then(function onAdapterResolution(response){throwIfCancellationRequested(config);response.data=transformData(response.data,response.headers,config.transformResponse);return response},function onAdapterRejection(reason){if(!isCancel(reason)){throwIfCancellationRequested(config);if(reason&&reason.response){reason.response.data=transformData(reason.response.data,reason.response.headers,config.transformResponse)}}
            return Promise.reject(reason)})}}),(function(module,exports,__webpack_require__){"use strict";module.exports=function enhanceError(error,config,code,request,response){error.config=config;if(code){error.code=code}
    error.request=request;error.response=response;return error}}),(function(module,exports,__webpack_require__){"use strict";var createError=__webpack_require__(7);module.exports=function settle(resolve,reject,response){var validateStatus=response.config.validateStatus;if(!response.status||!validateStatus||validateStatus(response.status)){resolve(response)}else{reject(createError('Request failed with status code '+response.status,response.config,null,response.request,response))}}}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);module.exports=function transformData(data,headers,fns){utils.forEach(fns,function transform(fn){data=fn(data,headers)});return data}}),(function(module,exports,__webpack_require__){"use strict";var chars='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';function E(){this.message='String contains an invalid character'}
    ...
    module.exports=function buildURL(url,params,paramsSerializer){if(!params){return url}
        ...
        return url}}),(function(module,exports,__webpack_require__){"use strict";module.exports=function combineURLs(baseURL,relativeURL){return relativeURL?baseURL.replace(/\/+$/,'')+'/'+relativeURL.replace(/^\/+/,''):baseURL}}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);module.exports=(utils.isStandardBrowserEnv()?(function standardBrowserEnv(){return{write:function write(name,value,expires,path,domain,secure){var cookie=[];cookie.push(name+'='+encodeURIComponent(value));if(utils.isNumber(expires)){cookie.push('expires='+new Date(expires).toGMTString())}
    ...
    originURL=resolveURL(window.location.href);return function isURLSameOrigin(requestURL){var parsed=(utils.isString(requestURL))?resolveURL(requestURL):requestURL;return(parsed.protocol===originURL.protocol&&parsed.host===originURL.host)}})():(function nonStandardBrowserEnv(){return function isURLSameOrigin(){return!0}})())}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);module.exports=function normalizeHeaderName(headers,normalizedName){utils.forEach(headers,function processHeader(value,name){if(name!==normalizedName&&name.toUpperCase()===normalizedName.toUpperCase()){headers[normalizedName]=value;delete headers[name]}})}}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);var ignoreDuplicateOf=['age','authorization','content-length','content-type','etag','expires','from','host','if-modified-since','if-unmodified-since','last-modified','location','max-forwards','proxy-authorization','referer','retry-after','user-agent'];module.exports=function parseHeaders(headers){var parsed={};var key;var val;var i;if(!headers){return parsed}
    utils.forEach(headers.split('\n'),function parser(line){i=line.indexOf(':');key=utils.trim(line.substr(0,i)).toLowerCase();val=utils.trim(line.substr(i+1));if(key){if(parsed[key]&&ignoreDuplicateOf.indexOf(key)>=0){return}
        if(key==='set-cookie'){parsed[key]=(parsed[key]?parsed[key]:[]).concat([val])}else{parsed[key]=parsed[key]?parsed[key]+', '+val:val}}});return parsed}}),(function(module,exports,__webpack_require__){"use strict";module.exports=function spread(callback){return function wrap(arr){return callback.apply(null,arr)}}}),(function(module,exports,__webpack_require__){__webpack_require__(11);const axios=__webpack_require__(1);const Vue=__webpack_require__(15);const formTable=__webpack_require__(14);const formAddingBook=__webpack_require__(12);const formChangingBook=__webpack_require__(13);new Vue({el:'#app',data:{books:[]},components:{formTable:formTable,formAddingBook:formAddingBook,formChangingBook:formChangingBook},created:function(){const self=this;axios.get('/library/getAllBooks').then(function(booksFromDB){booksFromDB.data.forEach(book=>{self.books.push(book)})}).catch(function(error){console.log(error)})}})}),(function(module,exports,__webpack_require__){const axios=__webpack_require__(1);module.exports={data:function(){return{formAddingBook:{title:"",year:"",authors:""}}},methods:{addNewBook:function(){if(!this.isValidForm()){return}
            const self=this;const params=new URLSearchParams();params.append('title',this.formAddingBook.title);params.append('year',this.formAddingBook.year);params.append('authors[]',this.formAddingBook.authors);axios({method:'post',url:'/library/addBook',data:params}).then(function(response){if(response.data){self.addBookInTable();alert("Book \""+self.formAddingBook.title+"\" was added.")}else{alert("Book \""+self.formAddingBook.title+"\" wasn't added.")}}).catch(function(error){console.log(error);alert("Book \""+self.formAddingBook.title+"\" wasn't added.")})},isValidForm:function(){const selfForm=this.formAddingBook;if(selfForm.title===""){alert("Title of the book is empty.");return!1}else if(selfForm.year===""){alert("Year of publishing of the book is empty.");return!1}else if(selfForm.authors===""){alert("Authors of the book are absent.");return!1}else if(this.isExistBook(selfForm.title)){alert("Book with title \""+selfForm.title+"\" already exist.");return!1}else{return!0}},isExistBook:function(title){for(var i=0;i<this.$root.$data.books.length;i++){if(this.$root.$data.books[i].title===title){return!0}}
            return!1},addBookInTable:function(){const selfForm=this.formAddingBook;this.$root.$data.books.push({title:selfForm.title,year:selfForm.year,authors:new Array(selfForm.authors.split(','))})}}}}),(function(module,exports,__webpack_require__){const axios=__webpack_require__(1);module.exports={data:function(){return{formChangingBook:{selectedTitle:"",newTitle:"",newYear:"",newAuthors:""}}},methods:{onChangeSelectedBook:function(){const self=this.formChangingBook;this.$root.$data.books.forEach(book=>{if(book.title===self.selectedTitle){self.newTitle=book.title;self.newYear=book.year;self.newAuthors=book.authors}})},changeSelectedBook:function(){if(!this.isValidForm()){return}
            const self=this;const params=new URLSearchParams();params.append('oldTitle',this.formChangingBook.selectedTitle);params.append('newTitle',this.formChangingBook.newTitle);params.append('newYear',this.formChangingBook.newYear);params.append('newAuthors[]',this.formChangingBook.newAuthors);axios({method:'put',url:'/library/changeBook',data:params}).then(function(response){if(response.data){self.changeBookInTable();alert("Book \""+self.formChangingBook.selectedTitle+"\" was changed.")}else{alert("Book \""+self.formChangingBook.selectedTitle+"\" was changed.")}}).catch(function(error){console.log(error);alert("Book \""+self.formChangingBook.selectedTitle+"\" wasn't changed.")})},isValidForm:function(){const selfForm=this.formChangingBook;if(selfForm.selectedTitle===""){alert("Book doesn;t select.");return!1}else if(selfForm.newTitle===""){alert("New title of the book is empty.");return!1}else if(selfForm.newYear===""){alert("New year of publishing of the book is empty.");return!1}else if(selfForm.newAuthors===""){alert("New authors of the book are absent.");return!1}else if(this.isExistBook(selfForm.newTitle)){alert("Book with title \""+selfForm.newTitle+"\" already exist.");return!1}else{return!0}},isExistBook:function(title){const selfForm=this.formChangingBook;if(selfForm.selectedTitle===title){return!1}
            for(var i=0;i<this.$root.$data.books.length;i++){if(this.$root.$data.books[i].title===title){return!0}}
            return!1},changeBookInTable:function(){const selfForm=this.formChangingBook;this.$root.$data.books.forEach(book=>{if(book.title===selfForm.selectedTitle){book.title=selfForm.newTitle;book.year=selfForm.newYear;book.authors=selfForm.newAuthors}})}}}}),(function(module,exports,__webpack_require__){const axios=__webpack_require__(1);module.exports={data:function(){return{selectedBooks:[],searchBooks:""}},methods:{removeBooksByTitle:function(){const self=this;if(this.selectedBooks.length===0){alert("No books selected for deleting...");return}
            axios.delete('/library/deleteBook',{data:this.selectedBooks}).then(function(response){if(response.data){self.removeBooksFromTable();alert("Books \""+self.selectedBooks.toString()+"\" were deleted.");self.selectedBooks=[]}else{alert("Books \""+self.selectedBooks.toString()+"\" weren't deleted.")}}).catch(function(error){console.log(error);alert("Books \""+self.selectedBooks.toString()+"\" weren't deleted.")})},removeBooksFromTable:function(){this.selectedBooks.forEach(selectedBook=>{var index=this.$root.$data.books.map(task=>{return task.title}).indexOf(selectedBook);this.$root.$data.books.splice(index,1)})}},computed:{filteredBooks:function(){var query=this.searchBooks;return this.$root.$data.books.filter(function(book){if(query===''){return!0}else{return book.title.indexOf(query)>-1}})}}}}),(function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(9)();exports.push([module.i,"\n.full-height {\n  height: 100%;\n}\n@media (max-width: 1010px) {\n.full-height {\n    height: auto;\n}\n}\n",""])}),(function(module,exports){module.exports=function(obj){return obj!=null&&(isBuffer(obj)||isSlowBuffer(obj)||!!obj._isBuffer)}
    function isBuffer(obj){return!!obj.constructor&&typeof obj.constructor.isBuffer==='function'&&obj.constructor.isBuffer(obj)}
    function isSlowBuffer(obj){return typeof obj.readFloatLE==='function'&&typeof obj.slice==='function'&&isBuffer(obj.slice(0,0))}}),(function(module,exports,__webpack_require__){(function(global,process){(function(global,undefined){"use strict";if(global.setImmediate){return}
    ...
    attachTo.setImmediate=setImmediate;attachTo.clearImmediate=clearImmediate}(typeof self==="undefined"?typeof global==="undefined"?this:global:self))}.call(exports,__webpack_require__(3),__webpack_require__(10)))}),(function(module,exports,__webpack_require__){(function(global){var scope=(typeof global!=="undefined"&&global)||(typeof self!=="undefined"&&self)||window;var apply=Function.prototype.apply;exports.setTimeout=function(){return new Timeout(apply.call(setTimeout,scope,arguments),clearTimeout)};exports.setInterval=function(){return new Timeout(apply.call(setInterval,scope,arguments),clearInterval)};exports.clearTimeout=exports.clearInterval=function(timeout){if(timeout){timeout.close()}};function Timeout(id,clearFn){this._id=id;this._clearFn=clearFn}
    Timeout.prototype.unref=Timeout.prototype.ref=function(){};Timeout.prototype.close=function(){this._clearFn.call(scope,this._id)};exports.enroll=function(item,msecs){clearTimeout(item._idleTimeoutId);item._idleTimeout=msecs};exports.unenroll=function(item){clearTimeout(item._idleTimeoutId);item._idleTimeout=-1};exports._unrefActive=exports.active=function(item){clearTimeout(item._idleTimeoutId);var msecs=item._idleTimeout;if(msecs>=0){item._idleTimeoutId=setTimeout(function onTimeout(){if(item._onTimeout)
        item._onTimeout()},msecs)}};__webpack_require__(39);exports.setImmediate=(typeof self!=="undefined"&&self.setImmediate)||(typeof global!=="undefined"&&global.setImmediate)||(this&&this.setImmediate);exports.clearImmediate=(typeof self!=="undefined"&&self.clearImmediate)||(typeof global!=="undefined"&&global.clearImmediate)||(this&&this.clearImmediate)}.call(exports,__webpack_require__(3)))}),(function(module,exports){module.exports={render:function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"block"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.searchBooks),expression:"searchBooks"}],staticClass:"half-width ",attrs:{"type":"text","placeholder":"Search by title..."},domProps:{"value":(_vm.searchBooks)},on:{"input":function($event){if($event.target.composing){return}
                _vm.searchBooks=$event.target.value}}}),_vm._v(" "),_c('button',{on:{"click":_vm.removeBooksByTitle}},[_vm._v("Remove books")]),_vm._v(" "),_c('table',{staticClass:"table table-striped"},[_c('thead',{staticClass:"thead-inverse"},[_c('tr',[_c('th',[_vm._v("#"+_vm._s(_vm.$root.$data.books.length))]),_vm._v(" "),_c('th',[_vm._v("Name book")]),_vm._v(" "),_c('th',[_vm._v("Year")]),_vm._v(" "),_c('th',[_vm._v("Authors")])])]),_vm._v(" "),_c('tbody',_vm._l((_vm.filteredBooks),function(book){return _c('tr',[_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.selectedBooks),expression:"selectedBooks"}],attrs:{"type":"checkbox"},domProps:{"value":book.title,"checked":Array.isArray(_vm.selectedBooks)?_vm._i(_vm.selectedBooks,book.title)>-1:(_vm.selectedBooks)},on:{"change":function($event){var $$a=_vm.selectedBooks,$$el=$event.target,$$c=$$el.checked?(!0):(!1);if(Array.isArray($$a)){var $$v=book.title,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.selectedBooks=$$a.concat([$$v]))}else{$$i>-1&&(_vm.selectedBooks=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.selectedBooks=$$c}}}})]),_vm._v(" "),_c('td',[_vm._v(_vm._s(book.title))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(book.year))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(book.authors.toString()))])])}))])])},staticRenderFns:[]}}),(function(module,exports){module.exports={render:function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"block"},[_c('p',{staticClass:"hint"},[_vm._v("Select book:")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.formChangingBook.selectedTitle),expression:"formChangingBook.selectedTitle"}],staticClass:"full-width",on:{"change":[function($event){var $$selectedVal=Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val="_value" in o?o._value:o.value;return val});_vm.$set(_vm.formChangingBook,"selectedTitle",$event.target.multiple?$$selectedVal:$$selectedVal[0])},_vm.onChangeSelectedBook]}},_vm._l((_vm.$root.$data.books),function(book){return _c('option',[_vm._v(_vm._s(book.title))])})),_vm._v(" "),_c('p',{staticClass:"hint"},[_vm._v("Enter new name book["+_vm._s(_vm.formChangingBook.newTitle.length)+"/200]:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.formChangingBook.newTitle),expression:"formChangingBook.newTitle"}],staticClass:"full-width",attrs:{"type":"text"},domProps:{"value":(_vm.formChangingBook.newTitle)},on:{"input":function($event){if($event.target.composing){return}
                _vm.$set(_vm.formChangingBook,"newTitle",$event.target.value)}}}),_vm._v(" "),_c('p',{staticClass:"hint"},[_vm._v("Enter new year of publishing:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.formChangingBook.newYear),expression:"formChangingBook.newYear"}],staticClass:"full-width",attrs:{"type":"number"},domProps:{"value":(_vm.formChangingBook.newYear)},on:{"input":function($event){if($event.target.composing){return}
                _vm.$set(_vm.formChangingBook,"newYear",$event.target.value)}}}),_vm._v(" "),_c('p',{staticClass:"hint"},[_vm._v("Enter new authors separated by commas["+_vm._s(_vm.formChangingBook.newAuthors.length)+"/1000]:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.formChangingBook.newAuthors),expression:"formChangingBook.newAuthors"}],staticClass:"full-width",attrs:{"type":"text"},domProps:{"value":(_vm.formChangingBook.newAuthors)},on:{"input":function($event){if($event.target.composing){return}
                _vm.$set(_vm.formChangingBook,"newAuthors",$event.target.value)}}}),_vm._v(" "),_c('button',{staticClass:"full-width",on:{"click":_vm.changeSelectedBook}},[_vm._v("Change book")])])},staticRenderFns:[]}}),(function(module,exports){module.exports={render:function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"block"},[_c('p',{staticClass:"hint"},[_vm._v("Enter name book ["+_vm._s(_vm.formAddingBook.title.length)+"/200]:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.formAddingBook.title),expression:"formAddingBook.title"}],staticClass:"full-width",attrs:{"maxlength":"200","type":"text"},domProps:{"value":(_vm.formAddingBook.title)},on:{"input":function($event){if($event.target.composing){return}
                _vm.$set(_vm.formAddingBook,"title",$event.target.value)}}}),_vm._v(" "),_c('p',{staticClass:"hint"},[_vm._v("Enter year of publishing:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.formAddingBook.year),expression:"formAddingBook.year"}],staticClass:"full-width",attrs:{"type":"number"},domProps:{"value":(_vm.formAddingBook.year)},on:{"input":function($event){if($event.target.composing){return}
                _vm.$set(_vm.formAddingBook,"year",$event.target.value)}}}),_vm._v(" "),_c('p',{staticClass:"hint"},[_vm._v("Enter authors separated by commas["+_vm._s(_vm.formAddingBook.authors.length)+"/1000]:")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.formAddingBook.authors),expression:"formAddingBook.authors"}],staticClass:"full-width",attrs:{"type":"text"},domProps:{"value":(_vm.formAddingBook.authors)},on:{"input":function($event){if($event.target.composing){return}
                _vm.$set(_vm.formAddingBook,"authors",$event.target.value)}}}),_vm._v(" "),_c('button',{staticClass:"full-width",on:{"click":_vm.addNewBook}},[_vm._v("Add new book")])])},staticRenderFns:[]}}),(function(module,exports){var stylesInDom={},memoize=function(fn){var memo;return function(){if(typeof memo==="undefined")memo=fn.apply(this,arguments);return memo}},isOldIE=memoize(function(){return/msie [6-9]\b/.test(window.navigator.userAgent.toLowerCase())}),getHeadElement=memoize(function(){return document.head||document.getElementsByTagName("head")[0]}),singletonElement=null,singletonCounter=0,styleElementsInsertedAtTop=[];module.exports=function(list,options){if(typeof DEBUG!=="undefined"&&DEBUG){if(typeof document!=="object")throw new Error("The style-loader cannot be used in a non-browser environment")}
    ...
    function applyToTag(styleElement,obj){var css=obj.css;var media=obj.media;var sourceMap=obj.sourceMap;if(media){styleElement.setAttribute("media",media)}
        ...
        if(styleElement.styleSheet){styleElement.styleSheet.cssText=css}else{while(styleElement.firstChild){styleElement.removeChild(styleElement.firstChild)}
            styleElement.appendChild(document.createTextNode(css))}}}),(function(module,exports,__webpack_require__){var content=__webpack_require__(37);if(typeof content==='string')content=[[module.i,content,'']];var update=__webpack_require__(44)(content,{});if(content.locals)module.exports=content.locals;if(!1){if(!content.locals){module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2b0ee8e7!../node_modules/sass-loader/index.js?indentedSyntax=true!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./formTable.vue",function(){var newContent=require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2b0ee8e7!../node_modules/sass-loader/index.js?indentedSyntax=true!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./formTable.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent)})}
